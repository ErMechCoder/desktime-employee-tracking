...
const TaskList = () => {
	...
	const  user ="https://images.pexels.com/photos/14693027/pexels-photo-14693027.jpeg?auto=compress&cs=tinysrgb&w=600"
	const attachment ="https://images.pexels.com/photos/14693027/pexels-photo-14693027.jpeg?auto=compress&cs=tinysrgb&w=600"
            ...
            <div className="page-wrapper">
				<div className="">
					...
					<div className="sidebar-menu">
						<ul>
							<li> 
								<a href="/"><i className="la la-home"></i> <span>Back to Home</span></a>
							</li>
							<li className="menu-title">Projects <a href="#" data-toggle="modal" data-target="#create_project"><i className="fa fa-plus"></i></a></li>
							<li> 
								<a href="/project/tasklist">Project Management</a>
							</li>
							<li className="active"> 
								<a href="/project/tasklist">Hospital Administration</a>
							</li>
							<li> 
								<a href="/project/tasklist">Video Calling App</a>
							</li>
							<li> 
								<a href="/project/tasklist">Office Management</a>
							</li>
						</ul>
					</div>
                </div>
						...
						<div className="col-lg-4 message-view task-view task-left-sidebar">
							<div className="chat-window">
								<div className="fixed-header">
									<div className="navbar">
										...
										<a className="task-chat profile-rightbar float-right" id="" href="#task_window"><i className="fa fa fa-comment"></i></a>
										<ul className="nav float-right custom-menu">
											<li className="nav-item dropdown dropdown-action">
												<a href="" className="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">setting</a>
															...
															<ul id="task-list">
																...
																<li className="task">
																	<div className="task-container">
																		...
																		<span className="task-label" >Appointment booking with payment gateway</span>
																		<span className="task-action-btn task-btn-right">
																			<span className="action-circle large" title="Assign">
																				<i className="material-icons">person_add</i>
																			</span>
																...
																<li className="task">
																	<div className="task-container">
																		...
																		<span className="task-label" >Patient and Doctor video conferencing</span>
																		<span className="task-action-btn task-btn-right">
																			<span className="action-circle large" title="Assign">
																				<i className="material-icons">person_add</i>
																			</span>
																...
																<li className="task">
																	<div className="task-container">
																		...
																		<span className="task-label" >Private chat module</span>
																		<span className="task-action-btn task-btn-right">
																			<span className="action-circle large" title="Assign">
																				<i className="material-icons">person_add</i>
																			</span>
																...
																<li className="task">
																	<div className="task-container">
																		...
																		<span className="task-label" >Patient Profile add</span>
																		<span className="task-action-btn task-btn-right">
																			<span className="action-circle large" title="Assign">
																				<i className="material-icons">person_add</i>
																			</span>
						...
						<div className="col-lg-4 message-view task-chat-view task-right-sidebar" id="task_window">
							<div className="chat-window">
								<div className="fixed-header">
									<div className="navbar">
												...
												<div className="chats">
													...
													<div className="chat chat-left">
														...
														<div className="chat-body">
															<div className="chat-bubble">
																<div className="chat-content">
																	<span className="task-chat-user">John Doe</span> <span className="file-attached">attached 3 files <i className="fa fa-paperclip"></i></span> <span className="chat-time">Feb 17, 2019 at 4:32am</span>
													...
													<div className="chat chat-left">
														...
														<div className="chat-body">
															<div className="chat-bubble">
																<div className="chat-content">
																	<span className="task-chat-user">Jeffery Lalor</span> <span className="file-attached">attached file <i className="fa fa-paperclip"></i></span> <span className="chat-time">Yesterday at 9:16pm</span>
																	<ul className="attach-list">
													...
													<div className="chat chat-left">
														...
														<div className="chat-body">
															<div className="chat-bubble">
																<div className="chat-content">
																	<span className="task-chat-user">Jeffery Lalor</span> <span className="file-attached">attached file <i className="fa fa-paperclip"></i></span> <span className="chat-time">Today at 12:42pm</span>
																	<ul className="attach-list">
